...
public class ExtendedAudioZoneStatusReport extends AudioZoneStatusReport {
    public ExtendedAudioZoneStatusReport() {
    }

	protected void initialize(SystemTypeEnum model,	ProtocolTypeEnum protocolType) throws CommunicationException {
    	ProtocolTypeHelper.ensureOmniLinkII(protocolType);
   		super.initialize(model, protocolType, ExtendedObjectStatusReport.MESSAGE_TYPE, 6, ObjectTypeEnum.AUDIO_ZONE, true);
	}

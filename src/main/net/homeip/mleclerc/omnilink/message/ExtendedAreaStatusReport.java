...
public class ExtendedAreaStatusReport extends AreaStatusReport {
    public ExtendedAreaStatusReport() {
    }

	protected void initialize(SystemTypeEnum model,	ProtocolTypeEnum protocolType) throws CommunicationException {
    	ProtocolTypeHelper.ensureOmniLinkII(protocolType);
   		super.initialize(model, protocolType, ExtendedObjectStatusReport.MESSAGE_TYPE, 6, ObjectTypeEnum.AREA, true);
	}

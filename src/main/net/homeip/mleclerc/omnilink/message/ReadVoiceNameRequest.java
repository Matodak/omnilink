...
public class ReadVoiceNameRequest extends RequestMessage {
	private NameTypeEnum nameType;
	private int objectNo;

	public ReadVoiceNameRequest(NameTypeEnum nameType, int objectNo) {
	...
	protected void initialize(SystemTypeEnum model, ProtocolTypeEnum protocolType) throws CommunicationException {
		...
		data[3] = 0x01;
		super.initialize(model, protocolType, 0x11, 0x05, data);
	}

	protected ReplyMessage createReplyMessage() throws CommunicationException {
		return new ReadVoiceNameReport();
	}
}

...
public class SystemInformationRequest extends RequestMessage {
    public SystemInformationRequest() {
    }

	protected void initialize(SystemTypeEnum model, ProtocolTypeEnum protocolType) throws CommunicationException {
		if (ProtocolTypeHelper.isOmniLinkII(protocolType)) {
			super.initialize(model, protocolType, 0x16, 0x01);			
		} else {
			super.initialize(model, protocolType, 0x11, 0x01);
		}
	}

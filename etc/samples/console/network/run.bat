...
REM === Compile the console code ===
%JAVA_HOME%\bin\javac -classpath %CLASS_PATH% MessageFactory.java Console.java NetworkMain.java

REM === Execute the console ====
%JAVA_HOME%\bin\java -classpath .;%CLASS_PATH% NetworkMain
